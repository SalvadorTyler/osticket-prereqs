...
<p>
Ok, so in this tutorial i will explain how to setup and install osticket a ticketing. First we will have to create a Virtual machine using the Microsoft Azure portal. We are using a VM in order to protect our physical machine just in case something breaks.
  
 <img src="https://imgur.com/eQMK8y8" height="80%" width="80%" alt="Disk Sanitization Steps"/>
</p>
<br />
<p>
</p>
